...
namespace Lively.Core.Wallpapers
{
    public class WebProcess : IWallpaper
    {
        ...
        public WebProcess(string path, ILibraryModel model, IDisplayMonitor display, string livelyPropertyPath, string debugPort, bool diskCache, int volume)
        {
        ...
        private void Proc_Exited(object sender, EventArgs e)
        {
            if (!_initialized)
            {
                ...
                {
                    Success = false,
                    Error = new Exception("ERROR"),//Properties.Resources.LivelyExceptionGeneral),
