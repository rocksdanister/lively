...
{
    public class ToolStripRendererLight : ToolStripProfessionalRenderer
    {
        public ToolStripRendererLight()
        ...
        protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            {
                var fillColor = new System.Drawing.SolidBrush(Color.FromArgb(225, 225, 225));
                var borderColor = new System.Drawing.Pen(Color.FromArgb(225, 225, 225));
        ...
        //    using Pen borderPen = new Pen(Color.FromArgb(125, 125, 125), 1f);
        ...
        {
            readonly Color foregroundGray = Color.FromArgb(255, 255, 255);
            readonly Color backgroundGray = Color.FromArgb(225, 225, 225);
